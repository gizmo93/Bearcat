...
using BearCat.Core.Hosters.Rapidgator.ApiClient.File;
using BearCat.Core.Hosters.Rapidgator.ApiClient.User;

namespace BearCat.Core.Hosters.Rapidgator.ApiClient;
    ...
    IHttpClientFactory httpClientFactory)
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var response = await httpClient.PostAsync(uploadUrl, new MultipartFormDataContent
        {
            {
        ...
        return JsonSerializer.Deserialize<UploadFileResponse>(content, options: new JsonSerializerOptions
        {
