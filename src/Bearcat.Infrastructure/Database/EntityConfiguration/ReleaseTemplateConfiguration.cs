...
public class ReleaseTemplateConfiguration : IEntityTypeConfiguration<ReleaseTemplate>
{
    public void Configure(EntityTypeBuilder<ReleaseTemplate> builder)
    {
        ...
        builder.Property(t => t.ReleaseContentType).IsRequired();
        ...
        builder.Property(t => t.ReleaseCollectionKeyTemplate).IsRequired(false).HasMaxLength(500);
        builder.Property(t => t.ReleaseCollectionNameTemplate).IsRequired(false).HasMaxLength(500);
