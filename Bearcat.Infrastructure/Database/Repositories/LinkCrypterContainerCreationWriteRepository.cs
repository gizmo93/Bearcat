...
public class LinkCrypterContainerCreationWriteRepository(IBearcatWriteDbContext dbWrite) : ILinkCrypterContainerCreationWriteRepository
{
        ...
        CancellationToken cancellationToken)
    {
        return await dbWrite.Uploads
            ...
            .Where(u => u.UploadState == UploadState.Completed
                        ...
                        && u.UploadedFiles.Any()
                        && u.UploadConfig.LinkCrypters
                            .Any(l => l.LinkCrypterRegistration.IsActive
